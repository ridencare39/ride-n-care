...
posts.push(
  {
    slug: "monsoon-bike-care-bangalore",
    title: "Monsoon Bike Care: 9 Things Every Bangalore Rider Must Do",
    excerpt: "Bangalore monsoons are brutal on chains, brakes and electricals. Here's how to monsoon-proof your bike in one weekend.",
    date: "2026-06-02",
    author: "Ride N Care Team",
    readMins: 6,
    category: "Bike Care",
    tags: ["Bike", "Monsoon", "Maintenance"],
    body: [
  ...
  {
    slug: "car-battery-life-bangalore",
    title: "How Long Should a Car Battery Last in Bangalore?",
    excerpt: "Heat, short trips and idle months kill car batteries faster than you'd think. Here's how to add 18 months to its life.",
    date: "2026-05-30",
    author: "Ride N Care Team",
    readMins: 5,
    category: "Car Care",
    tags: ["Car", "Battery", "Tips"],
    body: [
  ...
  {
    slug: "top-bangalore-areas-doorstep-service",
    title: "Top 10 Bangalore Areas Where Doorstep Service Saves You the Most Time",
    excerpt: "Traffic-heavy localities where skipping the garage run gives back 3+ hours of your weekend.",
    date: "2026-05-25",
    author: "Ride N Care Team",
    readMins: 4,
    category: "Bangalore Guides",
    tags: ["Bangalore", "Doorstep", "Guide"],
    body: [
  ...
  {
    slug: "engine-oil-guide-bangalore",
    title: "Mineral vs Semi-Synthetic vs Fully Synthetic: Picking the Right Engine Oil",
    excerpt: "The oil you pour into your bike or car decides 60% of its long-term health. Here's the simple buying guide.",
    date: "2026-05-18",
    author: "Ride N Care Team",
    readMins: 7,
    category: "Bike Care",
    tags: ["Engine Oil", "Maintenance", "Guide"],
    body: [
  ...
  {
    slug: "car-service-cost-bangalore-2026",
    title: "Car Service Cost in Bangalore (2026): Real Numbers, No Hidden Fees",
    excerpt: "Hatchback, sedan, SUV — here's what a periodic service really costs in Bangalore in 2026, and where garages quietly upsell.",
    date: "2026-05-08",
    author: "Ride N Care Team",
    readMins: 6,
    category: "Bangalore Guides",
    tags: ["Car", "Pricing", "Bangalore"],
    body: [
