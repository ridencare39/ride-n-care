export function FloatingActions() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 px-3 pb-3 sm:px-6 sm:pb-5 pointer-events-none">
      <div className="pointer-events-auto mx-auto flex w-full max-w-xl items-stretch gap-2 rounded-2xl border border-border bg-card/95 p-2 shadow-lg backdrop-blur supports-[backdrop-filter]:bg-card/80">
        <a
          href="tel:+918296950339"
          aria-label="Call Ride N Care"
          className="flex min-w-0 flex-1 items-center justify-center gap-2 rounded-xl bg-grad-primary px-4 py-3.5 text-base font-semibold text-primary-foreground shadow-glow transition hover:opacity-95 active:scale-[0.98]"
        >
        ...
        <a
          ...
          className="flex min-w-0 flex-1 items-center justify-center gap-2 rounded-xl bg-[#25D366] px-4 py-3.5 text-base font-semibold text-white shadow-lg transition hover:opacity-95 active:scale-[0.98]"
        >
          <svg viewBox="0 0 32 32" className="h-5 w-5 shrink-0 fill-current" aria-hidden>
